...
const DashboardPage = () => {
    return (
        <div className="grid grid-rows gap-[10px] w-[full] items-center border-white bg-transparent mt-[10px] rounded-md">
            ...
            <div className="grid grid-cols-[2fr_8fr] gap-2 w-[full] h-[35vh] items-center border-white bg-amber-500 p-2 rounded-md">
                <div className="bg-orange-500 h-full rounded-md px-2 py-2 min-w-[180px]">
                    <CashflowForm/>
                </div>
            ...
            <div className="grid md:grid-cols-[10fr_4fr] lg:grid-cols-[10fr_4fr] gap-2 w-[full] h-[55vh] items-center border-white bg-amber-500 p-2 rounded-md">
